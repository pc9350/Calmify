        ...
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="text-center">
                    <h3 className="mt-8 text-lime-700 text-3xl font-bold sm:text-4xl">
                        Our Team!!
                    </h3>
                    <p className="text-gray-600 mt-3 italic">
                        Meet our talented Engineers who are passionate about building products that users love.
                    </p>
                </div>
                <div className="mt-12">
                            ...
                            team.map((item, idx) => (
                                <li key={idx} className="gap-8 sm:flex">
                                    ...
                                    <div className="mt-4 sm:mt-0 max-w-xs">
                                        ...
                                        <p className="text-lime-700">{item.title}</p>
